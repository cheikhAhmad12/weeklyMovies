...
# Toggle fake vs real extractor with env USE_FAKE_EXTRACT=true/1/yes
USE_FAKE_EXTRACT = os.getenv("USE_FAKE_EXTRACT", "false").lower() in ("1", "true", "yes")

if USE_FAKE_EXTRACT:
    from src.fake_extraction import weekly_releases, film_reviews  # type: ignore
else:
